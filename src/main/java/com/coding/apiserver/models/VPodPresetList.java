...
public class VPodPresetList {
  ...
  private List<VPodPreset> items = new ArrayList<VPodPreset>();
  ...
  public VPodPresetList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public VPodPresetList items(List<VPodPreset> items) {

    this.items = items;
    return this;
  }

  public VPodPresetList addItemsItem(VPodPreset itemsItem) {
  ...
  **/
  ...
  public List<VPodPreset> getItems() {
    return items;
  }


  public void setItems(List<VPodPreset> items) {
    this.items = items;
  }


  public VPodPresetList kind(String kind) {
  ...
  **/
  ...
  public VPodPresetList metadata(VListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VPodPresetList v1alpha1PodPresetList = (VPodPresetList) o;
