...
public class VPod extends VResource {

  // 注意：extends VResource; 指定 k_resource
  private static final String resourceName = "pod";
  public VPod() {
    super();
  ...
  private VPodStatus status;


  public VPod apiVersion(String apiVersion) {
  ...
  **/
  ...
  public VPod metadata(VObjectMeta metadata) {
  ...
  **/
  ...
  public VPod spec(VPodSpec spec) {
  ...
  **/
  ...
  public VPod status(VPodStatus status) {
  ...
  **/
  ...
  public VPodStatus getStatus() {
    return status;
  }


  public void setStatus(VPodStatus status) {
    this.status = status;
  }
