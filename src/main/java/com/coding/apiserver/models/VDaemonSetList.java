...
public class VDaemonSetList {
  ...
  private List<VDaemonSet> items = new ArrayList<VDaemonSet>();
  ...
  public VDaemonSetList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public VDaemonSetList items(List<VDaemonSet> items) {

    this.items = items;
    return this;
  }

  public VDaemonSetList addItemsItem(VDaemonSet itemsItem) {
  ...
  **/
  ...
  public List<VDaemonSet> getItems() {
    return items;
  }


  public void setItems(List<VDaemonSet> items) {
    this.items = items;
  }


  public VDaemonSetList kind(String kind) {
  ...
  **/
  ...
  public VDaemonSetList metadata(VListMeta metadata) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VDaemonSetList v1DaemonSetList = (VDaemonSetList) o;
