...
public class VIPBlock {
  ...
  public VIPBlock cidr(String cidr) {
  ...
  **/
  ...
  public VIPBlock except(List<String> except) {

    this.except = except;
    return this;
  }

  public VIPBlock addExceptItem(String exceptItem) {
    if (this.except == null) {
