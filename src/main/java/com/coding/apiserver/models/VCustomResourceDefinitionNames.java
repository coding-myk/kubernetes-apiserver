...
public class VCustomResourceDefinitionNames {
  ...
  public VCustomResourceDefinitionNames categories(List<String> categories) {

    this.categories = categories;
    return this;
  }

  public VCustomResourceDefinitionNames addCategoriesItem(String categoriesItem) {
  ...
  **/
  ...
  public VCustomResourceDefinitionNames kind(String kind) {
  ...
  **/
  ...
  public VCustomResourceDefinitionNames listKind(String listKind) {
  ...
  **/
  ...
  public VCustomResourceDefinitionNames plural(String plural) {
  ...
  **/
  ...
  public VCustomResourceDefinitionNames shortNames(List<String> shortNames) {

    this.shortNames = shortNames;
    return this;
  }

  public VCustomResourceDefinitionNames addShortNamesItem(String shortNamesItem) {
  ...
  **/
  ...
  public VCustomResourceDefinitionNames singular(String singular) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VCustomResourceDefinitionNames v1CustomResourceDefinitionNames = (VCustomResourceDefinitionNames) o;
