...
public class VJobList {
  ...
  private List<VJob> items = new ArrayList<VJob>();
  ...
  public VJobList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public VJobList items(List<VJob> items) {

    this.items = items;
    return this;
  }

  public VJobList addItemsItem(VJob itemsItem) {
  ...
  **/
  ...
  public List<VJob> getItems() {
    return items;
  }


  public void setItems(List<VJob> items) {
    this.items = items;
  }


  public VJobList kind(String kind) {
  ...
  **/
  ...
  public VJobList metadata(VListMeta metadata) {
