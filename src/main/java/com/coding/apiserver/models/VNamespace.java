...
public class VNamespace extends VResource {

  // 注意：extends VResource; 指定 k_resource
  private static final String resourceName = "namespace";
  public VNamespace() {
    super();
  ...
  private VNamespaceSpec spec;

  public static final String SERIALIZED_NAME_STATUS = "status";
  @SerializedName(SERIALIZED_NAME_STATUS)
  private VNamespaceStatus status;


  public VNamespace apiVersion(String apiVersion) {
  ...
  **/
  ...
  public VNamespace kind(String kind) {
  ...
  **/
  ...
  public VNamespace metadata(VObjectMeta metadata) {
  ...
  **/
  ...
  public VNamespace spec(VNamespaceSpec spec) {
  ...
  **/
  ...
  public VNamespaceSpec getSpec() {
    return spec;
  }


  public void setSpec(VNamespaceSpec spec) {
    this.spec = spec;
  }


  public VNamespace status(VNamespaceStatus status) {
  ...
  **/
  ...
  public VNamespaceStatus getStatus() {
    return status;
  }


  public void setStatus(VNamespaceStatus status) {
    this.status = status;
  }
  ...
  public boolean equals(Object o) {
    ...
    VNamespace v1Namespace = (VNamespace) o;
