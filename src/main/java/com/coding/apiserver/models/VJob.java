...
public class VJob {
  ...
  private VJobStatus status;


  public VJob apiVersion(String apiVersion) {
  ...
  **/
  ...
  public VJob metadata(VObjectMeta metadata) {
  ...
  **/
  ...
  public VJob spec(VJobSpec spec) {
  ...
  **/
  ...
  public VJob status(VJobStatus status) {
  ...
  **/
  ...
  public VJobStatus getStatus() {
    return status;
  }


  public void setStatus(VJobStatus status) {
    this.status = status;
  }
