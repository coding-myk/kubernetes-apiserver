...
public class VSecret extends VResource {

  // 注意：extends VResource; 指定 k_resource
  private static final String resourceName = "secret";
  public VSecret() {
    super();
  ...
  public VSecret apiVersion(String apiVersion) {
  ...
  **/
  ...
  public VSecret data(Map<String, byte[]> data) {

    this.data = data;
    return this;
  }

  public VSecret putDataItem(String key, byte[] dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public VSecret kind(String kind) {
  ...
  **/
  ...
  public VSecret metadata(VObjectMeta metadata) {
  ...
  **/
  ...
  public VSecret stringData(Map<String, String> stringData) {

    this.stringData = stringData;
    return this;
  }

  public VSecret putStringDataItem(String key, String stringDataItem) {
  ...
  **/
  ...
  public VSecret type(String type) {
