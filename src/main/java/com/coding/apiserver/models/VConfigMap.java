...
public class VConfigMap extends VResource {

  // 注意：extends VResource; 指定 k_resource
  private static final String resourceName = "configMap";
  public VConfigMap() {
    super();
  ...
  public VConfigMap apiVersion(String apiVersion) {
  ...
  **/
  ...
  public VConfigMap binaryData(Map<String, byte[]> binaryData) {

    this.binaryData = binaryData;
    return this;
  }

  public VConfigMap putBinaryDataItem(String key, byte[] binaryDataItem) {
  ...
  **/
  ...
  public VConfigMap data(Map<String, String> data) {

    this.data = data;
    return this;
  }

  public VConfigMap putDataItem(String key, String dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public VConfigMap kind(String kind) {
  ...
  **/
  ...
  public VConfigMap metadata(VObjectMeta metadata) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VConfigMap v1ConfigMap = (VConfigMap) o;
