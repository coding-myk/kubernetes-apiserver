...
public class VStatefulSet extends VResource {

  // 注意：extends VResource; 指定 k_resource
  private static final String resourceName = "statefulSet";
  public VStatefulSet() {
    super();
  ...
  private VStatefulSetSpec spec;

  public static final String SERIALIZED_NAME_STATUS = "status";
  @SerializedName(SERIALIZED_NAME_STATUS)
  private VStatefulSetStatus status;


  public VStatefulSet apiVersion(String apiVersion) {
  ...
  **/
  ...
  public VStatefulSet kind(String kind) {
  ...
  **/
  ...
  public VStatefulSet metadata(VObjectMeta metadata) {
  ...
  **/
  ...
  public VStatefulSet spec(VStatefulSetSpec spec) {
  ...
  **/
  ...
  public VStatefulSetSpec getSpec() {
    return spec;
  }


  public void setSpec(VStatefulSetSpec spec) {
    this.spec = spec;
  }


  public VStatefulSet status(VStatefulSetStatus status) {
  ...
  **/
  ...
  public VStatefulSetStatus getStatus() {
    return status;
  }


  public void setStatus(VStatefulSetStatus status) {
    this.status = status;
  }
  ...
  public boolean equals(Object o) {
    ...
    VStatefulSet v1StatefulSet = (VStatefulSet) o;
